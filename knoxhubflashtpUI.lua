...
function Ascended.new(cfg)
	...
	titleLbl.TextSize=11;titleLbl.TextXAlignment=Enum.TextXAlignment.Left;titleLbl.ZIndex=5

	-- close button
	local closeBtn=Instance.new("TextButton",titleBar)
	closeBtn.Size=UDim2.new(0,18,0,18);closeBtn.Position=UDim2.new(1,-22,0.5,-9)
	closeBtn.Text="×";closeBtn.TextSize=14;closeBtn.Font=Enum.Font.GothamBold
	closeBtn.TextColor3=Color3.fromRGB(150,150,150);closeBtn.BackgroundTransparency=1;closeBtn.ZIndex=5

	-- ── TAB BAR (horizontal, below title) ──────────────────────
	-- Scrolling so many tabs can fit; no scroll bar shown
	...
	self.Sidebar.ScrollingDirection=Enum.ScrollingDirection.X
	self.Sidebar.CanvasSize=UDim2.new(0,0,1,0)
	...
	-- auto-expand canvas width
	tabLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
		self.Sidebar.CanvasSize=UDim2.new(0,tabLayout.AbsoluteContentSize.X+4,1,0)
	end)
	...
	self.OpenBtn.Size=UDim2.new(0,38,0,38);self.OpenBtn.Position=UDim2.new(0.5,-19,0,-60)
	...
	local function Tgl()
		isM=not isM
		if isM then
			Tween(self.Main,{Size=UDim2.new(0,0,0,0)},0.2).Completed:Connect(function()
				self.Main.Visible=false;self.OpenBtn.Visible=true
				Tween(self.OpenBtn,{Position=UDim2.new(0.5,-19,0,12)},0.28,Enum.EasingStyle.Back)
			end)
		else
			self.Main.Visible=true;self.OpenBtn.Visible=false
			self.OpenBtn.Position=UDim2.new(0.5,-19,0,-60)
			Tween(self.Main,{Size=UDim2.new(0,W,0,H)},0.28,Enum.EasingStyle.Back)
		end
	end
...
function Ascended:CreateTab(n)
	...
	b.Size=UDim2.new(0,0,1,-6)  -- width auto via TextBounds + padding
	...
	local function activate()
		...
		for _,v in pairs(self.Sidebar:GetChildren())do
			if v:IsA("TextButton")then
				Tween(v,{TextColor3=Color3.fromRGB(110,110,110)},0.15)
	...
	if #self.Sidebar:GetChildren()==2 then activate() end
	...
	function f:CreateSlider(c)
		...
		t.TextColor3=Ascended.Theme.Text;t.Font=Enum.Font.Gotham;t.TextSize=11;t.TextXAlignment=Enum.TextXAlignment.Left
		...
		local function up()
			...
			v=val;Ascended.Flags[fl]=v;t.Text=c.Name.." : "..v
			fill.Size=UDim2.new(p,0,1,0);c.Callback(v);self.Lib:Save()
		end
		local dragging=false
		hitbox.InputBegan:Connect(function(i)if i.UserInputType==Enum.UserInputType.MouseButton1 or i.UserInputType==Enum.UserInputType.Touch then dragging=true;up()end end)
		UIS.InputChanged:Connect(function(i)if dragging and(i.UserInputType==Enum.UserInputType.MouseMovement or i.UserInputType==Enum.UserInputType.Touch)then up()end end)
	...
	function f:CreateButton(n,cb)
		...
		b.TextColor3=Ascended.Theme.Text;b.Font=Enum.Font.Gotham;b.TextSize=11
	...
	function f:CreateSection(n)
		...
		s.TextSize=10;s.TextXAlignment=Enum.TextXAlignment.Left
	end
	...
	function f:CreateInput(c)
		...
		lbl.BackgroundTransparency=1;lbl.Text=c.Name
		lbl.TextColor3=Ascended.Theme.Text;lbl.Font=Enum.Font.Gotham;lbl.TextSize=11
		...
		box.TextColor3=Ascended.Theme.Text;box.Font=Enum.Font.Gotham;box.TextSize=11
	...
	function f:CreateDropdown(c)
		...
		bt.Font=Enum.Font.Gotham;bt.TextSize=11;bt.TextXAlignment=Enum.TextXAlignment.Left
		...
		for _,o in pairs(c.Options)do
			...
			opt.Text=o;opt.TextColor3=Ascended.Theme.Text;opt.Font=Enum.Font.Gotham;opt.TextSize=11
	...
	function f:CreateInfo(c)
		...
		title.TextColor3=Ascended.Theme.Text;title.Font=Enum.Font.Gotham;title.TextSize=11
		...
		val.TextColor3=Color3.fromRGB(255,255,255);val.Font=Enum.Font.GothamBold;val.TextSize=11
