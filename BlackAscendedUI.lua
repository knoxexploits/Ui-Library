-- By Ashcended
local Ascended={Flags={},Theme={Main=Color3.fromRGB(10,10,10),Accent=Color3.fromRGB(160,160,160),Text=Color3.fromRGB(180,180,180),Glass=0.02},Config={Enabled=false,FileName="AscendedConfig.json"}}
