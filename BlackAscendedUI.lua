-- By Ashcended
local Ascended={Flags={},Theme={Main=Color3.fromRGB(15,15,15),Accent=Color3.fromRGB(255,215,0),Text=Color3.fromRGB(55,55,55),Glass=0.05},Config={Enabled=false,FileName="AscendedConfig.json"}}
...
local function createMiniButton(hub,flag,labelText,onToggle,initState)
    ...
    lbl.TextColor3=Color3.fromRGB(55,55,55);lbl.TextXAlignment=Enum.TextXAlignment.Left
    ...
    bindBox.TextColor3=Color3.fromRGB(55,55,55);bindBox.Font=Enum.Font.GothamBold
...
function Ascended:CreateMiniActionButton(c)
    ...
    lbl.Font=Enum.Font.GothamBold;lbl.TextSize=11
    lbl.TextColor3=Color3.fromRGB(200,200,200);lbl.TextXAlignment=Enum.TextXAlignment.Left
    lbl.TextTruncate=Enum.TextTruncate.AtEnd;lbl.ZIndex=11
    ...
    bindBox.Text=savedBind;bindBox.PlaceholderText="key"
    bindBox.PlaceholderColor3=Color3.fromRGB(80,80,80)
    bindBox.TextColor3=Color3.fromRGB(200,200,200);bindBox.Font=Enum.Font.GothamBold
    bindBox.TextSize=9;bindBox.ClearTextOnFocus=false;bindBox.ZIndex=12
    Instance.new("UICorner",bindBox).CornerRadius=UDim.new(0,5)
    local bindStroke=Instance.new("UIStroke",bindBox)
    bindStroke.Color=Color3.fromRGB(60,60,60);bindStroke.Thickness=1
